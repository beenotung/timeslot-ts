...
function compactSlots_test() {
    function test(name: string, startEnds: [string, string][], expected: [string, string][]) {
...
function isAvailable_test() {
    function test(name: string, availableSlots: StartEnd[], bookingSlot: StartEnd, expected: boolean) {
    ...
    ], {start: '09:00', end: '10:00'}, true)
    test('partly booking', [
        {start: '08:00', end: '11:00'}
    ], {start: '09:00', end: '10:00'}, true)
    test('pre-over-booking', [
        {start: '09:00', end: '10:00'}
    ], {start: '08:00', end: '10:00'}, false)
    test('post-over-booking', [
        {start: '09:00', end: '11:00'}
    ], {start: '08:00', end: '10:00'}, false)
    test('both-sided over-booking', [
        {start: '09:00', end: '10:00'}
    ], {start: '08:00', end: '11:00'}, false)
}
